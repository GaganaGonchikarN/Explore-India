...
<html>
	...
	<title>Home | explore_india</title>
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="3000">
			  	...
			  	<ol class="carousel-indicators">
				   ...
				   <div class="item active">
			    	  <img src="images/carousel/explore1.jpg" alt="Image1">
			    	</div>
				...
				<div class="col-xs-12 destinationHolder">
					...
					<div class="col-xs-12 containerGrids hvr-buzz-out">
						...
						<div class="col-xs-12 icons text-center">
							<img src="images/icons/hotel.jpg" width="320" height="250"  alt="hotels" class="iconsDim text-center"/>
						</div>
					...
					<div class="col-xs-12 containerGrids hvr-buzz-out">
						<a href="flights.php" style="color: black;">
							...
							<div class="col-xs-12 icons text-center">
								<img src="images/icons/flight.jpg" width="320" height="250" alt="flights" class="iconsDim text-center"/>
							</div>
					...
					<div class="col-xs-12 containerGrids hvr-buzz-out">
						<a href="trains.php" style="color: black;">
							...
							<div class="col-xs-12 icons text-center">
								<img src="images/icons/train.jpg" width="320" height="250"  alt="trains" class="iconsDim text-center"/>
							</div>
			...
			<div class="col-xs-12 popularDestinationsContainer">
				...
				<div class="col-xs-12 destinationHolder">
					...
					<div class="col-xs-12 containerGrids hvr-buzz-out">
						...
						<div class="col-xs-12 pics text-center">
							<img src="images/popularDestinations/imageKarnataka.jpg" alt="popularDestination1" class="picDim text-center"/>
						</div>
					...
					<div class="col-xs-12 containerGrids hvr-buzz-out">
						...
						<div class="col-xs-12 pics text-center">
							<img src="images/popularDestinations/imageKerala.jpg" alt="popularDestination1" class="picDim text-center"/>
						</div>
					...
					<div class="col-xs-12 containerGrids hvr-buzz-out">
						...
						<div class="col-xs-12 pics text-center">
							<img src="images/popularDestinations/imageGoa.jpg" alt="popularDestination1" class="picDim text-center"/>
						</div>
				...
				<div class="footerMod col-sm-12">
					...
					<div class="col-sm-4">
						...
						<div class="footerText">
							Yelahanka,Bangalore <br> Karnataka, India
						</div>
				
						<div class="footerText">
							E-mail: queries@explore_india.com
						</div>
					...
					<div class="col-sm-4">
						...
						<div class="socialLinks">
							...
							<div class="fb">
								facebook.com/explore_india
							</div>
						
							<div class="gp">
								plus.google.com/explore_india
							</div>
						
							<div class="tw">
								twitter.com/explore_india
							</div>
						
							<div class="in">
								linkedin.com/explore_india
							</div>
					...
					<div class="copyrightContainer">
						<div class="copyright">
						Copyright &copy; 2022 Explore India
						</div>
					</div>
					</div>
